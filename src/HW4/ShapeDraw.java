...
public class ShapeDraw extends JPanel {
    ...
    public ShapeDraw() {
        ...
        DrawingArea size = new DrawingArea();  // create the size

        sizeChoice = new JComboBox<String>();  // size choice menu
        sizeChoice.addItem("1X1");
        sizeChoice.addItem("2X2");
        sizeChoice.addItem("3X3");
        sizeChoice.addItem("4X4");
        sizeChoice.addActionListener(size);

        JButton rectButton = new JButton("Rect");    // buttons for adding shapes
        rectButton.addActionListener(canvas);
        rectButton.addActionListener(size);

        JButton ovalButton = new JButton("Oval");
        ovalButton.addActionListener(canvas);
        ovalButton.addActionListener(size);

        JButton roundRectButton = new JButton("RoundRect");
        roundRectButton.addActionListener(canvas);
        roundRectButton.addActionListener(size);
    ...
    class DrawingArea extends JPanel
            implements ActionListener, MouseListener, MouseMotionListener, Size {
        ...
        public void actionPerformed(ActionEvent evt) {
            ...
            // buttons have been set up to send action events to this canvas and size.
            // Respond by adding the appropriate shape to the canvas and size.
    ...
    static abstract class Shape implements Size {
